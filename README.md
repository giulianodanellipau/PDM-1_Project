...
Antônio, 45 anos, engenheiro automotivo, utiliza ônibus como transporte principal, passa por dificuldades com: 
- Os totens de recarga, apresentam falhas constantes e com poucas unidades disponíveis para uso em sua região. 
- Aplicativo do mesmo, não processa pagamentos, lento, com uma interface confusa. 

Persona 2:

Rosa, 36 anos, secretária, mora longe do trabalho e precisa utilizar o metrô como transporte diariamente, tendo um horário apertado, ela sofre com:
- Totens de tickets que se encontram cheios e falham em proteger informações sensíveis.
